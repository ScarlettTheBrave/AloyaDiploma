...
import {ChangePassword} from '../api/changePass.js'
export default function PasswordPage() {
  ...
  const handleSignUpClick = async () => {
    try {
      ...
      var response = await ChangePassword(password,confirmPassword);
  ...
  return (
    <div style={{background: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      ...
      xmlns=2544
        ...
        <span style={{fontFamily: 'Roboto, sans-serif',  textAlign: 'center', fontWeight: 'lighter', fontSize: '2vh', marginBottom: '5vh' }}>Change password </span>
        <PasswordInput 
        ...
        <Button type="primary" style={{background: 'black',height: '8vh',marginTop: '3vh', marginBottom: '2vh' }} onClick={handleSignUpClick}>Change password</Button>
