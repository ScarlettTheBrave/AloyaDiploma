...
export default function VerifyPage() {
  ...
  const handleSignUpClick = async () => {
    try {
      var response = await Verify(phone);
  ...
  return (
    <div style={{background: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      ...
      xmlns=2544
        ...
        <span style={{fontFamily: 'Roboto, sans-serif',  textAlign: 'center', fontWeight: 'lighter', fontSize: '2vh', marginBottom: '5vh' }}>Verify in Aloya </span>
        <AuthInput 
                    fieldsetStyles={{marginTop: '3vh'}}
                    ald="phone" legendPar='Phone'
                    onChange={handlePhoneChange}> 
                </AuthInput>
        <Button type="primary" style={{background: 'black',height: '8vh',marginTop: '3vh', marginBottom: '2vh' }} onClick={handleSignUpClick}>Verify</Button>
